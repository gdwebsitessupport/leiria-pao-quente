  ...
  pages: {
    ...
    gallery: {
      ...
      hero: {
        ...
        text: "High-quality placeholder images representing the space, products, and atmosphere.",
      },
      section: {
        eyebrow: "Atmosphere",
      ...
      items: [
        { title: "Freshly baked bread", image: images.hero },
        { title: "Golden croissants", image: images.pastry },
        { title: "Coffee at the counter", image: images.coffee },
        { title: "Sweet display", image: images.counter },
        { title: "Cakes to share", image: images.cake },
        { title: "Neighborhood bakes", image: images.bakery },
        { title: "Breakfasts", image: images.breakfast },
        { title: "Welcoming atmosphere", image: images.cafe },
      ],
    },
    team: {
      metadata: {
